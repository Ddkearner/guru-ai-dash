...
declare module 'lucide-react' {
    ...
    export type LucideProps = Partial<SVGProps<SVGSVGElement> & {
        size: string | number;
    ...
    export const ScissorsLine: LucideIcon;
    ...
    export const createLucideIcon: (iconName: string, iconNode: [string, any][]) => LucideIcon;
}
