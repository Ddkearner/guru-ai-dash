...
export const dropoutData: Student[] = [
  ...
  { id: 'stud5', name: 'Karan Verma', class: '9B', roll: 18, image: "https://picsum.photos/seed/stud5/100/100", performanceChange: -28, attendance: 70, feeStatus: 'Paid', grades: [{subject: 'Math', score: 40}, {subject: 'Science', score: 50}, {subject: 'English', score: 65}, {subject: 'History', score: 55}] },
